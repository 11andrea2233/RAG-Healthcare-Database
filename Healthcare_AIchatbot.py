...
if not api_key:
    ...
    if page == "Home":
        ...
        st.write(
            "Hello there! I am your new AI receptionist, designed to make life easier for both healthcare providers and patients. "
            "Think of me as a virtual assistant that can help answer patient questions, schedule appointments, provide medication "
            "reminders, handle basic billing inquiries, and share information about the clinic. I am here to make sure patients get "
            "the answer they need quickly and securely, while freeing up staff to focus on more important tasks."
        )
        st.write(
            "What makes me special? Well, I use advanced technology to look up the right information and respond accurately, like an "
            "efficient, friendly receptionist. I am always available and ready to assist, whether it's early in the morning or late at night."
        )
        ...
        st.write("3. Billing Questions. For simple billing questions, I can look up amounts and payment dates, and if things get too complicated, I will direct you to the billing team.")
        st.write("4. General Clinic Information. Whether it's clinic hours, location or accepted insurance plans, I have all the details to keep patients informed.")
        ...
        st.write("Answer Quickly: Patients don’t have to wait long for answers about appointments, medications, and billing—I can respond almost instantly!")
        ...
        This project is one of the projects I am building to try and apply the learning I have acquired from the AI First Bootcamp of AI Republic.
